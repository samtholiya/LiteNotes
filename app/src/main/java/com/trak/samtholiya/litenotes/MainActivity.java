...
public class MainActivity extends AppCompatActivity implements
    ...
    public static MainContent dummyContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdRequest adRequest = new AdRequest.Builder().addTestDevice("A03694246B0DB9A09A68551F074D5970").build();
        mAdView.loadAd(adRequest);

        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), LiteDetailActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

                intent.putExtra(LiteDetailActivity.LITEDATA, new MainContent.MainItem());
    ...
    @Override
    public void onListFragmentInteraction(MainContent.MainItem item) {
        Intent intent = new Intent(this.getApplicationContext(), LiteDetailActivity.class);
        intent.putExtra(LiteDetailActivity.LITEDATA, item);
        startActivity(intent);
    ...
    ResultReceiver mResultReceiver=new AddressResultReceiver(mHandler);
